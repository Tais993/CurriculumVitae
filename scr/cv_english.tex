...
%----------------------------------------------------------------------------------------
    ...
    \begin{twenty} % Environment for a list with descriptions
        ...
        {}
        {
            Working on an internal tool surrounding CI/CD, this tool is written in Java.
        }\\
        \twentyitem
        {Feb 2021 -}
        {Present}
...
%----------------------------------------------------------------------------------------
    ...
    \begin{twenty} % Environment for a list with descriptions
        ...
        {
            Just another Discord bot. But this time with localisation! Implementing it was easier than I originally thought. \\

        The bot also had statistics implemented using Prometheus, and this is my first project which uses SQL (MariaDB + HikariCP).}\\
...
%----------------------------------------------------------------------------------------
    ...
    \begin{twenty} % Environment for a list with descriptions
        ...
        One of the most active members of the project.
        }\\
